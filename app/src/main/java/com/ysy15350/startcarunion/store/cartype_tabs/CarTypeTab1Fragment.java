...
public class CarTypeTab1Fragment extends MVPBaseFragment<CarTypeTabViewInterface, CarTypeTabPresenter>
    ...
    private void loadCarType() {
        String carTypeJson = BaseData.getCache("carType" + 0);
    ...
    public void bindCarType(Response response) {
        ...
        if (response != null) {
            ...
            if (code == 200) {
                ...
                BaseData.setCache("carType" + 0, response.getResultJson(), 3600);//缓存时间单位：秒
