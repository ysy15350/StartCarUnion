...
public class SignSuccessDialog extends Dialog {
    ...
    public SignSuccessDialog(Context context, int score) {
        super(context);
    ...
    private void initView() {
        ...
        conentView = inflater.inflate(R.layout.dialog_sign, null);

        TextView tv_score = (TextView) conentView.findViewById(R.id.tv_score);
